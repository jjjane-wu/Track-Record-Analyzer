...
TEMPLATE_FIELDS: list[dict] = [
    ...
    {"id": "fund_currency", "label": "Financials Currency",             "aliases": ["fund currency", "currency", "ccy", "fund ccy", "local currency", "reporting currency", "deal currency", "financials currency"]},
