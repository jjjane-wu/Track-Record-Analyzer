...
Private Function TabBlurb(nm As String) As String
    Select Case nm
        ...
        Case "Return & Loss Ratios"
            TabBlurb = "Pooled MOIC and loss ratio across 15 cuts - sector, geography, vintage, fund, entry size, exit type - with a chart per cut"
        ...
        Case "Vintage Perf by Sector"
            TabBlurb = "Invested capital, MOIC and loss ratio by vintage, with vintage x sector count and MOIC matrices"
